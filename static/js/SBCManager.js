...

{
	...
	for (let i=0;i<data.ATTRIBUTE.length;i++)
	{
		...
		th1.style.width = "5%";
		th1.scope="row";
		th1.innerText = data.ATTRIBUTE[i][0];
				let th2 = document.createElement("td");
		th2.style.width = "45%";
		th2.scope="row";
		th2.innerText = data.ATTRIBUTE[i][1];
				let th3 = document.createElement("td");
		th3.style.width = "10%";
		th3.scope="row";
		th3.innerText = data.ATTRIBUTE[i][3];
				let th4 = document.createElement("td");
		th4.style.width = "10%";
		th4.scope="row";
		th4.innerText = data.ATTRIBUTE[i][4];
				let th5 = document.createElement("td");
		th5.style.width = "10%";
		th5.scope="row";
		th5.innerText = data.ATTRIBUTE[i][5];
				let th6 = document.createElement("td");
		th6.style.width = "10%";
		th6.scope="row";
		th6.innerText = data.ATTRIBUTE[i][9];
		tr.appendChild(th1);
		tr.appendChild(th2);
		tr.appendChild(th3);
		tr.appendChild(th4);
