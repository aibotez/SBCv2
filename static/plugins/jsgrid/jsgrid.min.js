...
!function (a, b, c) {
    ...
    d.prototype = {
        ...
        fieldOption: function (a, b, c) {
            return a = this._normalizeField(a),
        ...
        _createCell: function (a, c) {
            ...
            return d = b.isFunction(c.cellRenderer) ? this.renderTemplate(c.cellRenderer, c, f) : b("<td>").append(this.renderTemplate(c.itemTemplate || e, c, f)),
        ...
        _createPages: function () {
            ...
            for (var e = 0, f = c; b > e && a >= f; e++, f++)
                d.push(f === this.pageIndex ? this._createPagerCurrentPage() : this._createPagerPage(f));
            return a > c + b - 1 && d.push(this._createPagerPageNavButton(this.pageNavigatorNextText, this.showNextPages)),
            d
        },
        ...
        _controllerCall: function (a, c, d, e) {
            ...
            if (!f || !f[a])
                throw Error("controller has no method '" + a + "'");
        ...
        _validateItem: function (a, c) {
            ...
            if (this._eachField(function (f) {
                    if (f.validate && (c !== this._insertRow || f.inserting) && (c !== this._getEditRow() || f.editing)) {
                        ...
                        this._setCellValidity(c.children().eq(this._visibleFieldIndex(f)), h),
                        h.length && d.push.apply(d, b.map(h, function (a) {
                                return {
                                    field: f,
                                    message: a
                                }
            ...
            return this._callEventHandler(this.onItemInvalid, f),
            this.invalidNotify(f),
            !1
        },
        ...
        _createEditRow: function (a) {
            if (b.isFunction(this.editRowRenderer))
                return b(this.renderTemplate(this.editRowRenderer, this, {
                        item: a,
        ...
        deleteItem: function (b) {
            ...
            if (c.length && (!this.confirmDeleting || a.confirm(t(this.deleteConfirm, this, c.data(g)))))
        ...
        return this.each(function () {
            ...
            if (j)
                if ("string" == typeof a) {
                    ...
                    j._detachWindowResizeCallback(), j._init(a), j.render();
            else
                new d(i, a)
        }),
        h
    ...
    x = function (a) {
        var c;
        b.isPlainObject(a) ? c = d.prototype : (c = w[a].prototype, a = arguments[1] || {}),
        b.extend(c, a)
    },
    y = {},
    z = function (a) {
...
(jsGrid, jQuery), function (a, b, c) {
    ...
    d.prototype = {
        ...
        _normalizeRule: function (a) {
            ...
            return a = b.extend({}, a),
            b.isFunction(a.validator) ? a : this._applyNamedValidator(a, a.validator)
        },
        _applyNamedValidator: function (a, c) {
            delete a.validator;
            var d = e[c];
            if (!d)
                throw Error('unknown validator "' + c + '"');
    ...
    var e = {
        ...
        pattern: {
            ...
            validator: function (a, b, c) {
                return "string" == typeof c && (c = new RegExp("^(?:" + c + ")$")),
                c.test(a)
            }
        },
        range: {
